...
let make_topo () = 
  ...
  let () = G.add_node topo s1;
    ...
    G.add_edge topo s2 (Int32.of_int 4) ids (Int32.of_int 1);
    G.add_edge topo ids (Int32.of_int 1) s2 (Int32.of_int 4);

    G.add_edge topo s3 (Int32.of_int 4) ids (Int32.of_int 2);
    G.add_edge topo ids (Int32.of_int 2) s3 (Int32.of_int 4);
  in
  topo
